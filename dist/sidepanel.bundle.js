...
`;
  ...
  var init_purify_es = __esm({
    "node_modules/dompurify/dist/purify.es.mjs"() {
      ...
      text = freeze(["#text"]);
      html2 = freeze(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "pattern", "placeholder", "playsinline", "popover", "popovertarget", "popovertargetaction", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "wrap", "xmlns", "slot"]);
    ...
    "sidepanel.js"() {
      ...
      function addMessage(text2, sender, isComplete = true) {
        ...
        if (isGemini && !isComplete && currentGeminiMessageDiv) {
          ...
          contentSpan.classList.add("message-content", "prose", "prose-sm", "max-w-none");
          if (isGemini) {
            currentOutputText = text2;
            const dirtyHtml = marked.parse(currentOutputText);
            const cleanHtml = purify.sanitize(dirtyHtml);
          ...
          if (sender === "user") {
            ...
            messageDiv.appendChild(contentSpan);
            if (isComplete) {
              addCopyButton(messageDiv, text2);
